...
> **顺序写基线**大约是 **4.63 GiB/s**

- 
- 

> **顺序读基线**大约是 **6.81 GiB/s**
...
| **测试项** | **目标盘** | **bs** | **iodepth** | **rw** | **fio IOPS** | **fio带宽** | **clat avg** | **p99** | **iostat r/s or w/s** | **await** | **util** |
|:---|:---|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| randread_4k | nvme0n1 | 4K | 32 | randread |  |  |  |  |  |  |  |
| randwrite_4k | nvme0n1 | 4K | 32 | randwrite |  |  |  |  |  |  |  |
...
| **测试项** | **目标盘** | **bs** | **iodepth** | **rw** | **fio IOPS** | **fio带宽** | **clat avg** | **p99** | **iostat r/s or w/s** | **await** | **util** |
|:---|:---|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| randread_4k | nvme0n1 | 4K | 32 | randread | 326k | 1272 MiB/s | 95.68 us | 182 us | 324,840 ~ 326,364 r/s | 0.08 ms | 99.85% ~ 100% |
| randwrite_4k | nvme0n1 | 4K | 32 | randwrite | 319k | 1247 MiB/s | 97.64 us | 104 us | 316,184 ~ 323,957 w/s | 0.01 ms | 97.72% ~ 98.67% |
| randrw_4k_70r30w | nvme0n1 | 4K | 32 | randrw | read 223k / write 95.7k | read 872 MiB/s / write 374 MiB/s | read 120.89 us / write 43.67 us | read 326 us / write 69 us | read 223,077 ~ 226,052 r/s; write 95,592 ~ 96,547 w/s | r_await 0.09 ms / w_await 0.01 ms | 99.85% ~ 100% |
...
> **4K 随机读基线**约为 **326k IOPS / 1272 MiB/s**

- 
- 

> **4K 随机写基线**约为 **319k IOPS / 1247 MiB/s**
