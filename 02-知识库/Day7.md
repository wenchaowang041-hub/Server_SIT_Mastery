...
| **OS设备** | **容量** | **类型猜测**         | **备注**      |
|:-----------|---------:|:---------------------|:--------------|
| /dev/sda   |        ? | RAID逻辑盘 or 直通盘 | 系统盘/数据盘 |
| /dev/sdb   |        ? | ...                  | ...           |
...
# 四、最关键的一个发现：这 8 块不是 JBOD，而是“单盘 RAID0”
...
# 六、你现在已经可以把 Broadcom 到 Linux 的映射再往前推进一步
...
把![](media/image1.emf)![](media/image2.emf)![](media/image3.emf) Broadcom 的 **槽位→物理盘→DG/VD→Linux 盘符** 全部画成最终拓扑图。
...
| **EID:Slot** | **DID** | **DG** | **VD** | **OS Drive** | **型号**         | **状态** |
|:-------------|--------:|-------:|-------:|:-------------|:-----------------|:---------|
