...
# 十二、Day12 产出模板：网络吞吐记录

你今天的“硬性产出”可以按这个模板做。

| **测试时间** | **测试网口** | **链路速率** | **iperf3模式** | **测试时长** | **iperf3吞吐** | **sar观察** | **ip -s link变化** | **丢包/错误** | **结论** |
|:---|:---|:---|:---|---:|:---|:---|:---|:---|:---|
| 2026-03-25 xx:xx | eno1 | 1G | client-\>server | 30s | 941 Mbits/sec | txkB/s 持续高位 | TX bytes 明显增长 | 0/0 | 1G链路吞吐正常 |
...
| **测试网口** | **链路速率** | **测试方式** | **时长** | **iperf3吞吐** | **sar观察** | **ip -s link变化** | **错误/丢包** | **结论** |
|:---|:---|---:|---:|:---|:---|:---|:---|:---|
| eno1 | 1G Full | client-\>server | 30s | 943 Mbits/sec | txkB/s 稳定约 117000+ | TX bytes 增加约 3.5GB | 0 / 0 | 1G链路基线正常 |
...
| **测试时间** | **测试网口** | **链路状态** | **协商速率** | **测试方式** | **测试时长** | **iperf3 吞吐** | **sar 观察** | **ip -s link 变化** | **错误/丢包** | **结论** |
|:---|:---|:---|:---|:---|---:|:---|:---|:---|:---|:---|
| 模拟 | eno1 | UP / LOWER_UP | 1G Full | client -\> server | 30s | 943 Mbits/sec | txkB/s 稳定在 117000~118000 | TX bytes 增加约 3.5GB | 0 / 0 | 1G 链路吞吐正常，网口统计与压测结果一致 |
