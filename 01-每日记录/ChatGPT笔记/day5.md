...
3.  SAS：企业级磁盘接口、常用于服务器、通常配合HBA和Raid控制器

4.  Raid：是磁盘控制层、把多块物理盘组合成逻辑盘、提供冗余、重建、缓存等能力、radi0、1、5、50、10
...
1.  L sblk-d 查看块设备查看NAME：sda、sdb、SIZE字段、TYPE
...
\[N:0:0:1\] disk BIWIN AP443 1TB SSD\_\_1 /dev/nvme0n1
