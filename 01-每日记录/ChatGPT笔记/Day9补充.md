...
| **rw** | **bs** | **iodepth** | **numjobs** | **IOPS** | **BW** | **clat avg** | **p99** | **util** |
|----|----|----|----|----|----|----|----|----|
...
| **rw** | **bs** | **iodepth** | **numjobs** | **IOPS** | **BW** | **clat avg** | **p99** | **await** | **aqu-sz** | **util** |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| randread | 4K | 1 | 1 |  |  |  |  |  |  |  |
| randread | 4K | 4 | 1 |  |  |  |  |  |  |  |
| randread | 4K | 8 | 1 |  |  |  |  |  |  |  |
...
| **rw** | **bs** | **iodepth** | **numjobs** | **IOPS** | **BW** | **clat avg** | **p99** | **await** | **aqu-sz** | **util** |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| randread | 4K | 1 | 1 | 12.5k | 48.8 MiB/s | 76.4 us | 91 us | 0.07 ~ 0.08 ms | 0.94 | 90.93% ~ 92.67% |
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| randread | 4K | 1 | 1 | 12.5k | 48.8 MiB/s | 76.4 us | 91 us | 0.07 ~ 0.08 ms | 0.94 | 90.93% ~ 92.67% |
| randread | 4K | 8 | 1 | 109k | 426 MiB/s | 71.1 us | 129 us | 0.07 ms | 7.56 | 99.85% ~ 100% |
...
| randread | 4K | 1 | 1 | 12.5k | 48.8 MiB/s | 76.4 us | 91 us | 0.07 ~ 0.08 ms | 0.94 | 90.93% ~ 92.67% |
| randread | 4K | 8 | 1 | 109k | 426 MiB/s | 71.1 us | 129 us | 0.07 ms | 7.56 | 99.85% ~ 100% |
| randread | 4K | 32 | 1 | 330k | 1288 MiB/s | 94.5 us | 178 us | 0.08 ms | 25.80 ~ 25.96 | 99.84% ~ 100% |
...
说明这块盘在 QD8 时虽然已经打满 util，但**并没有到随机读 IOPS 上限**，继续加深队列仍然有明显收益。
...
| randread | 4K | 8 | 1 | 109k | 426 MiB/s | 71.1 us | 129 us | 0.07 ms | 7.56 | 99.85% ~ 100% |
| randread | 4K | 32 | 1 | 330k | 1288 MiB/s | 94.5 us | 178 us | 0.08 ms | 25.80 ~ 25.96 | 99.84% ~ 100% |
| randread | 4K | 64 | 1 | 336k | 1312 MiB/s | 188.0 us | 277 us | 0.08 ms | 26.26 ~ 26.31 | 99.85% ~ 100% |
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| randread | 4K | 32 | 1 | 330k | 1288 MiB/s | 94.5 us | 178 us | 0.08 ms | 25.80 ~ 25.96 | 99.84% ~ 100% |
| randread | 4K | 32 | 2 | 596k | 2330 MiB/s | 104.8 us | 233 us | 0.10 ms | 57.18 ~ 57.24 | 99.84% ~ 100% |
...
| randread | 4K | 32 | 1 | 330k | 1288 MiB/s | 94.5 us | 178 us | 0.08 ms | 25.80 ~ 25.96 | 99.84% ~ 100% |
| randread | 4K | 32 | 2 | 596k | 2330 MiB/s | 104.8 us | 233 us | 0.10 ms | 57.18 ~ 57.24 | 99.84% ~ 100% |
| randread | 4K | 32 | 4 | 903k | 3525 MiB/s | 139.4 us | 338 us | 0.13 ms | 121.53 ~ 121.56 | 99.84% ~ 100% |
...
| randread | 4K | 32 | 2 | 596k | 2330 MiB/s | 104.8 us | 233 us | 0.10 ms | 57.18 ~ 57.24 | 99.84% ~ 100% |
| randread | 4K | 32 | 4 | 903k | 3525 MiB/s | 139.4 us | 338 us | 0.13 ms | 121.53 ~ 121.56 | 99.84% ~ 100% |
| randread | 4K | 32 | 8 | 1199k | 4683 MiB/s | 211.3 us | 545 us | 0.21 ms | 250.02 ~ 250.18 | 100% |
